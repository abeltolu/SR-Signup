...
! function(t, e) {
    ...
    t.each("branch form header step wrapper".split(" "), function() {
        ...
        _create: function() {
            ...
            c[0].elements ? e = c : (e = c.find("form")).length || (e = c.closest("form")), (i = c.find(l.header)).length || (i = e.find(l.header)), d.elements = {
            ...
            }, h.attr("id") || h.attr("id", "wizard-" + ++s), d.elements.forward.click(function(t) {
                ...
                branchesActivated: [],
                stepsActivated: []
            }, d._stepCount = d.elements.steps.length, d._lastStepIndex = d._stepCount - 1, d._branchLabels = [], d.elements.steps.each(function(e) {
                d._branchLabels[e] = t(this).parent().attr("id")
            }), d._excludesFilter = function() {
                return !t(this).hasClass(l.stepClasses.exclude)
            }, l.transitions[o] || (l.transitions[o] = function(t) {
        ...
        _find: function(e, s, n) {
            ...
            if (null !== e && p.length)
                for (i = 0, o = (e = a(e)).length; i < o; i++) r = null, (c = typeof(l = e[i])) === d ? r = p.get(l) : "string" === c ? r = document.getElementById(l.replace("#", "")) : "object" === c && (l instanceof jQuery && l.length && (l = l[0]), l.nodeType && p.each(function(t, e) {
                    if (e === l) return r = e, !1
                })), r && h.push(r);
            return !1 === n ? h : t(h)
        },
        _move: function(s, n, r, i, a) {
            ...
            var d = this,
                l = d._currentState;
            "boolean" == typeof n && (a = i, i = r, r = n, n = e), !0 === r ? s > 0 ? d._fastForward(s, r, o) : a.call(d, l.stepsActivated[Math.max(0, s + (l.stepsActivated.length - 1))]) : -1 !== (s = d.stepIndex(s, n)) && (s > l.stepIndex ? d._fastForward(s, o) : o.call(d, s))
        },
        _state: function(e, s) {
            if (!this.isValidStepIndex(e)) return null;
            this.options;
            var r = t.extend(!0, {}, this._currentState);
            s = a(s || e), r.step = this.elements.steps.eq(e), r.branch = r.step.parent(), r.branchStepCount = r.branch.children(n.step).length, r.isMovingForward = e > r.stepIndex, r.stepIndexInBranch = r.branch.children(n.step).index(r.step);
            for (var i, o, d, l = 0, c = s.length; l < c; l++) e = s[l], i = this._branchLabels[e], !r.stepIndex || r.stepIndex < e ? t.inArray(e, r.stepsActivated) < 0 && (r.stepsActivated.push(e), t.inArray(i, r.branchesActivated) < 0 && r.branchesActivated.push(i)) : r.stepIndex > e && (o = t.inArray(i, r.branchesActivated) + 1, d = t.inArray(e, r.stepsActivated) + 1, o > 0 && r.branchesActivated.splice(o, r.branchesActivated.length - 1), d > 0 && r.stepsActivated.splice(d, r.stepsActivated.length - 1)), r.stepIndex = e, r.branchLabel = i;
            return r.stepsComplete = Math.max(0, this._find(r.stepsActivated, this.elements.steps).filter(this._excludesFilter).length - 1), r.stepsPossible = Math.max(0, this._find(r.branchesActivated, this.elements.branches).children(n.step).filter(this._excludesFilter).length - 1), t.extend(r, {
        ...
        destroy: function() {
            var e = this.elements;
            this._trigger("beforeDestroy", null, this.state()) && (this.element.removeClass("wizard"), e.form.removeClass(r.form), e.header.removeClass(r.header), e.steps.show().removeClass(r.step), e.stepsWrapper.removeClass(r.wrapper), e.branches.removeClass(r.branch), t.Widget.prototype.destroy.call(this), this._trigger("afterDestroy"))
        },
        form: function() {
            return this.elements.form
        },
        forward: function(t, s, n) {
            typeof t === d && (n = s, s = t, t = e), s === e && (s = 1), this._currentState.isLastStep || typeof s !== d || this._move(s, !0, n, function(e, s) {
                this._update(t, this._state(e, s))
            })
        },
        ...
        select: function(s, n, r, i, a) {
            s instanceof t.Event || (a = i, i = r, r = n, n = s, s = e), n !== e && (t.isArray(n) ? (a = i, i = r, r = n[1], n = n[0]) : "boolean" == typeof r ? (a = i, i = r, r = e) : t.isArray(r) && (a = r, r = e), this._move(n, r, i, a, function(t, e) {
        ...
        step: function(s, n) {
            ...
            var i;
            return typeof s === d ? i = this._find(s, n !== e ? this.steps(n) : this.elements.steps) : (i = this._find(s, this.elements.steps.add(this.elements.branches))) && i.hasClass(r.branch) && (i = this._find(n || 0, this.steps(i))), i
        },
...
(function($, window, undefined) {
    ...
    function RoundSlider(n, t) {
        n.id && (window[n.id] = this), this.control = $(n), this.options = $.extend({}, this.defaults, t), this._raise("beforeCreate") !== !1 ? (this._init(), this._raise("create")) : this._removeData()
    }
        ...
        for (var i, r, u = 0; u < this.length; u++)
            if (i = this[u], r = $data(i, pluginName), r) {
                if ($isPlainObject(n)) typeof r.option == "function" ? r.option(n) : i.id && window[i.id] && typeof window[i.id].option == "function" && window[i.id].option(n);
                    ...
                    if ((n === "option" || n.indexOf("get") === 0) && t[2] === undefined) return r[n](t[1]);
                    r[n](t[1], t[2])
                }
    ...
    $.fn[pluginName] = function(n) {
        ...
        _init: function() {
            ...
            this._isBrowserSupport = this._isBrowserSupported(), this._isKO = !1, this._isAngular = !1, this.control.is("input") && (this._isInputType = !0, this._hiddenField = this.control, this.control = createElement("div"), this.control.insertAfter(this._hiddenField), this.options.value = this._hiddenField.val() || this.options.value, t = this, this._checkKO() && setTimeout(function() {
                t._checkKO()
            }, 1), this._checkAngular()), this._bindOnDrag = !1, n = this._dataElement().attr("data-updateon"), typeof n == "string" ? n == "drag" && (this._bindOnDrag = !0) : this._isAngular && (this._bindOnDrag = !0), this._onInit()
        },
        _onInit: function() {
            this._initialize(), this._update(), this._render()
        },
        _initialize: function() {
            this._isBrowserSupport && (this._isReadOnly = !1, this._checkDataType(), this._refreshCircleShape())
        },
        _render: function() {
            if (this.container = createElement("div.rs-container"), this.innerContainer = createElement("div.rs-inner-container"), this.block = createElement("div.rs-block rs-outer rs-border"), this.container.append(this.innerContainer.append(this.block)), this.control.addClass("rs-control").empty().append(this.container), this._setRadius(), this._isBrowserSupport) this._createLayers(), this._setProperties(), this._setValue(), this._updateTooltipPos(), this._bindControlEvents("_bind"), this._checkIE();
                ...
                n.html(typeof this._throwError == "function" ? this._throwError() : this._throwError), this.control.empty().addClass("rs-error").append(n), this._isInputType && this.control.append(this._dataElement())
            }
        },
        _update: function() {
        ...
        _createLayers: function() {
            var i = this.options.width,
                t = this._start,
                n;
            n = createElement("div.rs-path rs-transition"), this._rangeSlider || this._showRange ? (this.block1 = n.clone().addClass("rs-range-color").rsRotate(t), this.block2 = n.clone().addClass("rs-range-color").css("opacity", "0").rsRotate(t), this.block3 = n.clone().addClass("rs-path-color").rsRotate(t), this.block4 = n.addClass("rs-path-color").css({
                opacity: "1",
                "z-index": "1"
            }).rsRotate(t - 180), this.block.append(this.block1, this.block2, this.block3, this.block4).addClass("rs-split")) : this.block.append(n.addClass("rs-path-color")), this.lastBlock = createElement("span.rs-block").css({
                padding: i
        ...
        _setProperties: function() {
            this._updatePre(), this._setHandleShape(), this._addAnimation(), this._appendTooltip(), this.options.showTooltip || this._removeTooltip(), this.options.disabled ? this.disable() : this.options.readOnly && this._readOnly(!0), this.options.mouseScrollAction && this._bindScrollEvents("_bind")
        },
        _updatePre: function() {
        ...
        _tooltipEditable: function() {
            if (this.tooltip && this.options.showTooltip) {
                var n;
                this.options.editableTooltip ? (this.tooltip.addClass("edit"), n = "_bind") : (this.tooltip.removeClass("edit"), n = "_unbind"), this[n](this.tooltip, "click", this._editTooltip)
            }
        },
        _editTooltip: function() {
            if (this.tooltip.hasClass("edit") && !this._isReadOnly) {
                ...
                }), this.tooltip.html(this.input).removeClass("edit").addClass("hover"), this.input.focus().val(this._getTooltipValue(!0)), this._bind(this.input, "blur", this._focusOut), this._bind(this.input, "change", this._focusOut)
            }
        },
        _focusOut: function(n) {
            n.type == "change" ? (this.options.value = this.input.val().replace("-", ","), this._analyzeModelValue(), this._validateModelValue(), this._setValue(), this.input.val(this._getTooltipValue(!0))) : (this.tooltip.addClass("edit").removeClass("hover"), this._updateTooltip()), this._raiseEvent("change")
        },
        _setHandleShape: function() {
            var n = this.options.handleShape;
            this._handles().removeClass("rs-handle-dot rs-handle-square"), n == "dot" ? this._handles().addClass("rs-handle-dot") : n == "square" ? this._handles().addClass("rs-handle-square") : this.options.handleShape = this.defaults.handleShape
        },
        ...
        _border: function(n) {
            return n ? parseFloat(this._startLine.children().css("border-bottom-width")) : parseFloat(this.block.css("border-top-width")) * 2
        },
        ...
        _refreshSeperator: function() {
            var i = this._startLine.add(this._endLine),
                ...
                f = this._border(),
                t = u + f;
            n.lineCap == "round" && n.circleShape != "full" ? (i.addClass("rs-rounded"), r.css({
                width: t,
                height: t / 2 + 1
            }), this._startLine.children().css("margin-top", -1).addClass(n.sliderType == "min-range" ? "rs-range-color" : "rs-path-color"), this._endLine.children().css("margin-top", t / -2).addClass("rs-path-color")) : (i.removeClass("rs-rounded"), r.css({
                width: t,
                "margin-top": this._border(!0) / -2
        ...
        _createHandle: function(n) {
            var t = createElement("div.rs-handle rs-move"),
                u = this.options,
                f, r;
            (f = u.handleShape) != "round" && t.addClass("rs-handle-" + f), t.attr({
                index: n,
                tabIndex: "0"
            });
            var i = this._dataElement()[0].id,
                i = i ? i + "_" : "",
                e = i + "handle" + (u.sliderType == "range" ? "_" + (n == 1 ? "start" : "end") : "");
            return t.attr({
                role: "slider",
                "aria-label": e
            }), r = createElement("div.rs-bar rs-transition").css("z-index", "7").append(t).rsRotate(this._start), r.addClass(u.sliderType == "range" && n == 2 ? "rs-second" : "rs-first"), this.container.append(r), this._refreshHandle(), this.bar = r, this._active = n, n != 1 && n != 2 && (this["_handle" + n] = this._handleDefaults()), this._bind(t, "focus", this._handleFocus), this._bind(t, "blur", this._handleBlur), t
        },
        ...
        _activeHandleBar: function(n) {
            return n = n != undefined ? n : this._active, $(this.container.children("div.rs-bar")[n - 1])
        },
        ...
        _raiseEvent: function(n) {
            var t = this["_pre" + n];
            if (t !== this.options.value) return this["_pre" + n] = this.options.value, this._updateTooltip(), (n == "change" || this._bindOnDrag && n == "drag") && this._updateHidden(), this._raise(n, {
        ...
        _handleDown: function(n) {
            n.preventDefault();
            var t = $(n.target);
            t.focus(), this._removeAnimation(), this._bindMouseEvents("_bind"), this.bar = t.parent(), this._active = parseFloat(t.attr("index")), this._handles().removeClass("rs-move"), this._raise("start", {
                value: this.options.value,
                handle: this._handleArgs()
            })
        },
        ...
        _bindControlEvents: function(n) {
            this[n](this.control, "mousedown", this._elementDown), this[n](this.control, "touchstart", this._elementDown)
        },
        _bindScrollEvents: function(n) {
            this[n](this.control, "mousewheel", this._elementScroll), this[n](this.control, "DOMMouseScroll", this._elementScroll)
        },
        _bindMouseEvents: function(n) {
            this[n]($(document), "mousemove", this._handleMove), this[n]($(document), "mouseup", this._handleUp), this[n]($(document), "mouseleave", this._handleUp), this[n]($(document), "touchmove", this._handleMove), this[n]($(document), "touchend", this._handleUp), this[n]($(document), "touchcancel", this._handleUp)
        },
        _bindKeyboardEvents: function(n) {
            this[n]($(document), "keydown", this._handleKeyDown), this[n]($(document), "keyup", this._handleKeyUp)
        },
            ...
            if (this._rangeSlider || this._showRange) {
                if (this._active == 1 && u <= this._oriAngle(this._handle2.angle) || this._active == 2 && u >= this._oriAngle(this._handle1.angle) || this._invertRange) {
                    this["_handle" + this._active] = {
                        angle: t,
                        value: n
                    }, this.options.value = this._rangeSlider ? this._handle1.value + "," + this._handle2.value : n, this.bar.rsRotate(i), this._updateARIA(n);
                    var r = this._oriAngle(this._handle2.angle) - this._oriAngle(this._handle1.angle),
                        f = "1",
                        e = "0";
        ...
        _checkKO: function() {
            ...
            if (typeof f == "string" && typeof ko == "object") {
                if (t = ko.dataFor(this._dataElement()[0]), typeof t == "undefined") return !0;
                for (i = f.split(","), n = 0; n < i.length; n++)
                    if (u = i[n].split(":"), $.trim(u[0]) == "value") {
                        r = $.trim(u[1]);
                        break
                    }
                r && (this._isKO = !0, ko.computed(function() {
        ...
        _checkAngle: function(n, t) {
            ...
            } else if (t && (u = this._handleDragDistance, isNumber(u) && Math.abs(f - r) > u)) return i;
            return n
        },
        ...
        _appendHiddenField: function() {
            this._hiddenField = this._hiddenField || createElement("input"), this._hiddenField.attr({
                type: "hidden",
                name: this._dataElement()[0].id || ""
            }), this.control.append(this._hiddenField), this._updateHidden()
        },
        _updateHidden: function() {
            var n = this.options.value;
            this._hiddenField.val(n), (this._isKO || this._isAngular) && this._hiddenField.trigger("change"), this._isAngular && (this._scope()[this._ngName] = n)
        },
        ...
        _getTooltipValue: function(n) {
            if (this._rangeSlider) {
                ...
                return n ? t[0] + " - " + t[1] : this._tooltipValue(t[0], 1) + " - " + this._tooltipValue(t[1], 2)
            }
        ...
        _refreshCircleShape: function() {
            var n = this.options.circleShape,
                ...
                t;
            i.indexOf(n) == -1 && (t = ["h1", "h2", "h3", "h4", "q1", "q2", "q3", "q4", "3/4", "ch", "cq"].indexOf(n), n = t != -1 ? i[t] : n == "half" ? "half-top" : n == "quarter" ? "quarter-top-left" : "full"), this.options.circleShape = n
        },
        ...
        _checkOverlay: function(n, t) {
            ...
            i.length == 0 && (i = createElement("div" + n + " rs-transition rs-bg-color"), this.container.append(i)), i.rsRotate(this._start + t)
        },
        ...
        _validateSliderType: function() {
            ...
            this._rangeSlider = this._showRange = !1, n == "range" ? this._rangeSlider = this._showRange = !0 : n.indexOf("min") != -1 ? (this._showRange = !0, n = "min-range") : n = "default", this.options.sliderType = n
        },
        ...
        _analyzeModelValue: function() {
            var n = this.options.value,
                ...
                f = this.options.max,
                u, r, i;
            n instanceof Array && (n = n.toString()), i = typeof n == "string" ? n.split(",") : [n], this._rangeSlider ? r = typeof n == "string" ? i.length >= 2 ? (isNumber(i[0]) ? i[0] : t) + "," + (isNumber(i[1]) ? i[1] : f) : isNumber(i[0]) ? t + "," + i[0] : t + "," + t : isNumber(n) ? t + "," + n : t + "," + t : typeof n == "string" ? (u = i.pop(), r = isNumber(u) ? parseFloat(u) : t) : r = isNumber(n) ? parseFloat(n) : t, this.options.value = r
        },
        _validateModelValue: function() {
            ...
            if (this._rangeSlider) {
                var u = r.split(","),
                    n = parseFloat(u[0]),
                    t = parseFloat(u[1]);
                n = this._limitValue(n), t = this._limitValue(t), this._invertRange || n > t && (t = n), this._handle1 = this._processStepByValue(n), this._handle2 = this._processStepByValue(t), this.options.value = this._handle1.value + "," + this._handle2.value
        ...
        _raise: function(n, t) {
            ...
            return t = t || {
                value: u.value
            }, t.options = u, i && (t.type = n, typeof i == "string" && (i = window[i]), $.isFunction(i) && (r = i.call(this, t), r = r === !1 ? !1 : r)), this.control.trigger($.Event ? $.Event(n, t) : n), r
        },
        ...
        _removeData: function() {
            ...
            $.removeData && $.removeData(n, pluginName), n.id && delete window[n.id]
        },
        ...
        _readOnly: function(n) {
            this._isReadOnly = n, this.container.removeClass("rs-readonly"), n && this.container.addClass("rs-readonly")
        },
        _get: function(n) {
        ...
        getValue: function(n) {
            if (this.options.sliderType == "range" && isNumber(n)) {
                var t = parseFloat(n);
